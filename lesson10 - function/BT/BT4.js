...
// if(checkUserId(n)){
//     console.log(`User co id trung voi so ${n} la: ${users[userId].first_name} ${users[userId].last_name}`);
// }
// else{
//     console.log(`Ko co User nao co id trung voi so ${n}`);
// }


///
// let keyword = prompt(`Nhap chuoi keyword`);
...
//     let fullName = users.first_name + " " + users.last_name;
...
//     }
// }
// console.log(`So luong user co age > 50 la: ${count}`);

//Đếm số lượng user đã kết hôn và chưa kết hôn

// let countMariage = 0;
// let countNoMariage = 0;
// for (let user of users){
//     if (user.is_married){
//         countMariage ++;
//     }
...
//     }
// }
// console.log(`So luong user da ket hoon la: ${countMariage}`);
// console.log(`So luong user chua ket hon la: ${countNoMariage}`);

//Đếm số lượng user theo từng ngành nghề tương ứng
// const jobArray = [];

// for (let user of users){
//     jobArray.push(users.job);
// }
// for (let i=0;i<jobArray.length;i++){
//     for (let j=0;i<jobArray.length;i++){
